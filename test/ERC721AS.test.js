...
describe("ERC721AS", async function () {
    ...
    context(`Schooling`, function () {
        it(`Schooling Simulation`, async function () {
            ...
            for(var k=0; k<5; k++) {
                ...
                expect((await tester.schoolingBegin()).toNumber()).to.equal(simTime + 100);
                expect((await tester.schoolingEnd()).toNumber()).to.equal(simTime + 300);
                expect((await tester.schoolingBreaktime()).toNumber()).to.equal(10);
